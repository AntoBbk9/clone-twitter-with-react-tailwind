            ...
            <img src="/image_twitter/Profile-Photo.png" alt="photo de profil" />
                <div >
                        <div className="flex gap-3 items-center">
                            <p className="hidden sm:block text-white">Bradley Ortiz</p>
                            <img src="/image_twitter/Vector.png" alt="" className="hidden sm:w-5 h-4"/>
                        </div>
                        <p className="hidden sm:block text-graycolor2">@Bradleyortiz</p>
                </div>
